<div id="cookieConsent" class="fixed bottom-0 inset-x-0 p-4 bg-green-700 text-white text-center" style="display:none;">
    <div class="flex justify-center items-center">
        <span class="mr-4">Bu web sitesi, en iyi deneyimi sunmak için çerezler kullanmaktadır.</span>
        <button onclick="acceptCookies()" class="bg-green-500 text-white font-semibold py-2 px-4 rounded hover:bg-green-600">Kabul Et</button>
    </div>
</div>
<footer class="bg-green-900 text-white py-6">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex items-center mb-4 md:mb-0">
            <img src="<?=setting("favicon")?>" alt="Wel Studios Logo" class="h-12 w-12 mr-3">

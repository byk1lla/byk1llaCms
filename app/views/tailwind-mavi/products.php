...
<div class="container mx-auto py-12">
    ...
    <section class="text-center py-20 bg-blue-800 text-white">
        <h1 class="text-5xl font-bold mb-4"><?=setting('products_title')?></h1>
        <p class="text-xl"><?=setting('product_description')?></p>
    </section>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden transition transform hover:scale-105 hover:shadow-2xl">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-end">
                                ...
                                <p class="text-[1vh] text-gray-400 text-right">Kategorisi: <?= $category->getCategoryName(htmlspecialchars($product['category_id'])) ?></p>
                            </div>
                        </div>

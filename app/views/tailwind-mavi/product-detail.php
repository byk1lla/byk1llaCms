...
<div class="container mx-auto py-12">
    ...
    <nav class="bg-white p-3 rounded-lg shadow-lg mb-6">
        <ol class="list-reset flex text-gray-700">
            <li><a href="/products" class="text-blue-500 hover:underline">Ürünlerimiz</a></li>
            <li><span class="mx-2">/</span></li>
            <li><a href="/category/<?= $categoryData['id'] ?>" class="text-blue-500 hover:underline"><?= htmlspecialchars($categoryData['name']) ?></a></li>
            <li><span class="mx-2">/</span></li>
    ...
    <section class="py-12">
        <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-blue-500 font-bold text-2xl"><?= htmlspecialchars($productData['price']) ?> ₺</p>
            </div>
        </div>
    </section>

    <div class="text-center mt-6">
        <a href="/products" class="inline-block bg-blue-500 text-white py-2 px-4 rounded-lg shadow-lg hover:bg-blue-600">Tüm Ürünler</a>
    </div>
</div>

...
<div id="app">
    ...
    <div id="main">
                        ...
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="username">Hizmet Başlığı</label>
                                ...
                                <button type="submit" name="submit" class="btn btn-primary mt-3">Hizmet Ekle</button>
                            </form>
                        </div>
                    </div>
                </div>
       ...
       <?=darkalert('Merhaba','Bu mesajı ananızın amından getiriyom',"ok tm","inanilmaz!","tıklat")?>
